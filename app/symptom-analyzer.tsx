...
import { healthApi, SymptomAnalysisRequest, SymptomAnalysisResponse } from '@/services/healthApi';
...
export default function SymptomAnalyzerScreen() {
  ...
  const handleAnalyzeSymptoms = async () => {
    ...
    try {
      ...
      const response = await healthApi.analyzeSymptom(request);
      setResult(response);
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {result && (
          <View style={styles.resultSection}>
            ...
            {result.classification === 'Allergic Reaction' && (
